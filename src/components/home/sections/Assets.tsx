	...
	return (
		<section className='my-[5vh] flex flex-col gap-8 overflow-hidden'>
			...
			<div className='flex flex-col gap-8 lg:flex-row xl:gap-20 items-center'>
					...
					<div className='flex flex-1 flex-col gap-4 px-4 py-2 lg:h-[370px] lg:justify-between'>
						<div
							...
							<p>
								...
								d’établissements repertoriés. Travaillez où vous voulez,
								quand vous voulez et avec qui vous voulez.
							</p>
						</div>
						<div
							className='group relative hover:border-primary'
							...
							<p>
								...
								autres. Vous n’êtes qu’à un clic de rencontrer de
								nouveaux coworkers.
							</p>
						</div>
						<div
				...
				<div className='relative h-[250px] w-screen sm:h-[380px] lg:h-[370px] 2xl:h-[430px] '>
					<Image
						src={asset.imgSource}
						alt={asset.imgAlt}
						fill={true}
