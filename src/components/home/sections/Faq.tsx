...
const Faq = () => {
	return (
		<section className='my-[10vh] flex flex-col gap-8 overflow-x-hidden px-4 lg:h-[100vh]'>
				...
				<Accordion>
					<AccordionItem>
						...
						<AccordionContent>
							...
							travailler chacun dans son coin, à la maison ou dans un
							bureau isolé, l&apos;idée du coworking, c&apos;est de
							partager un grand espace de travail où tout le monde peut
							échanger, collaborer, et pourquoi pas, partager un café ou
							un repas à l&apos;occasion.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem>
						<AccordionTrigger>
						...
						<AccordionContent>
							...
							proposent des espaces de travail partagés gratuitement :
							les cafés, les restaurants, les hôtels, les bibliothèques,
							les espaces de coworking associatifs, les espaces de
							coworking d&apos;entreprises, les espaces de coworking dans
							les tiers-lieux, les espaces de coworking dans les centres
							commerciaux etc.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem>
