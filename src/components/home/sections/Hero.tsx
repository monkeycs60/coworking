    ...
    return (
        <section className='overall-bg mb-[10vh] flex w-full flex-col justify-center lg:mb-0 lg:h-screen'>
            <div className='mt-3 flex  flex-col gap-4 sm:mt-20  sm:gap-10 lg:-mt-4 lg:flex-row  lg:gap-0 2xl:-mt-28 2xl:gap-10 3xl:-mt-20 '>
                <div className='flex flex-col px-4 lg:w-[55%] lg:px-20 2xl:px-10 3xl:w-[50%] 3xl:px-0'>
                ...
                <div className='mt-[5vh] flex justify-center lg:mt-0 lg:w-[45%] lg:justify-end 2xl:w-1/2 2xl:items-start '>
                    ...
                    >
                        ...
                        <Image
                            ...
                            alt='fleche jaune'
                            className='absolute -left-64 bottom-4 z-20 hidden lg:bottom-[-120px] lg:left-[-170px] lg:block lg:w-[260px] 2xl:bottom-[-100px] 2xl:left-[-190px] 2xl:w-[350px] 3xl:pointer-events-none 3xl:bottom-[-90px] 3xl:left-[-170px] 3xl:h-[300px] 3xl:w-[300px] '
                        />
                        <Image
                            width={160}
                            height={160}
