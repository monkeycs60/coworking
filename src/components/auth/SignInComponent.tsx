...
const SignInComponent = () => {
    ...
    console.log('waitingToSubmit', waitingToSubmit);
    ...
    return (
        <section className='mt-[80px] 3xl:mt-[100px]'>
            <form
                ...
                className='m-auto mt-8 flex w-1/3 flex-col gap-2 rounded-2xl bg-white p-6 text-black'
            >
                ...
                <button
                    type='submit'
                    className='m-auto my-2 w-2/3 rounded-2xl bg-primary px-8 py-2 font-semibold text-white hover:bg-primary/70'
                >
                    Connectez-vous
                </button>
