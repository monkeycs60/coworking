    ...
    const steps = [
        {
            ...
            subtitle:
                'Nous avons pris soin de préremplir tous les champs... ou presque. Merci de bien vérifier que les informations sont exactes et de les corriger si nécessaire.',
        ...
        <FormProvider {...formMethods}>
            ...
            >
                <div className='flex flex-col items-center justify-center gap-8'>
                    ...
                    {currentStep === 5 && (
                        <>
                            <Review errors={formMethods.formState.errors} />
                            <button
                                type='submit'
                    ...
                    {currentStep === 1 ? (
                        ...
                        <button onClick={goToPrevStep}>Précédent</button>
                    )}
